...
import com.curso.AppJAR.databinding.ActivitySpinnerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                if (primeraVez)
                {
                    Log.d(Constantes.TAG_LOG, "ES LA PRIMERA VEZ (el usuario en realidad no ha tocado el spinner)")
                    primeraVez = false
                } else {

                    Log.d(Constantes.TAG_LOG, "OPCIÓN $position SELECCIONADA")
            ...
            override fun onNothingSelected(parent: AdapterView<*>?) {
                Log.d(Constantes.TAG_LOG, "OPCIÓN ELIMINADA DEL SPINNER")
            }
        }
